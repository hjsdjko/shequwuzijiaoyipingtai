...
public class WuziOrderView extends WuziOrderEntity implements Serializable {
	...
	*/
	...
	private String wuziOrderPaymentValue;
	...
	* 获取： 支付类型的值
	*/
	public String getWuziOrderPaymentValue() {
		return wuziOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setWuziOrderPaymentValue(String wuziOrderPaymentValue) {
		this.wuziOrderPaymentValue = wuziOrderPaymentValue;
	}
	...
	public String toString() {
		return "WuziOrderView{" +
			...
			", wuziOrderPaymentValue=" + wuziOrderPaymentValue +
